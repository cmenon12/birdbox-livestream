...
do
  ...
  ffmpeg -re -stream_loop -1 -i ./music/all-variable-120-mono.mp3 -i - -map 1:v -map 0:a -vcodec copy -acodec copy -strict experimental -f flv -b:v 3000k -b:a 40k -maxrate 3040k -preset ultrafast $url
