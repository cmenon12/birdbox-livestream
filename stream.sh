...
while true
do
  raspivid -t 0 -w 1280 -h 720 -fps 25 -n -br 60 -co 10 -sh 70 -sa -100 -l -o - -a 1036 -a "%a %d %b %Y at %H:%M %Z" -ae 18,0xff,0x808000 -ISO 600 -b 4000000 | ffmpeg -re -stream_loop -1 -i ./music/plan-working-128.mp3 -i - -map 1:v -map 0:a -vcodec copy -acodec copy -ab 128k -g 50 -strict experimental -f flv -b:v 4000k -b:a 128k -maxrate 4128k -bufsize 2064k -preset veryfast $url -report
